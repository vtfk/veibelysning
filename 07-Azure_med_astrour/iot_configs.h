...
// Wifi
#define IOT_CONFIG_WIFI_SSID conf_SSID
#define IOT_CONFIG_WIFI_PASSWORD conf_PASSWORD
...
// Azure IoT Central
#define DPS_ID_SCOPE conf_SCOPE
#define IOT_CONFIG_DEVICE_ID conf_DEVICE_ID
// Use device key if not using certificates
#ifndef IOT_CONFIG_USE_X509_CERT
#define IOT_CONFIG_DEVICE_KEY conf_DEVICE_KEY
#endif // IOT_CONFIG_USE_X509_CERT
